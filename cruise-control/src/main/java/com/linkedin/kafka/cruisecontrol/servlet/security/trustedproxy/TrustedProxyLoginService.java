...
public class TrustedProxyLoginService extends ContainerLifeCycle implements LoginService {
  ...
  public UserIdentity login(String username, Object credentials, Request request, Function<Boolean, Session> getOrCreateSession) {
    ...
    if (doAsUser == null && _fallbackToSpnegoAllowed) {
      RoleDelegateUserIdentity fallbackIdentity = (RoleDelegateUserIdentity) _fallbackSpnegoLoginService.login(username, credentials, request, getOrCreateSession);
      ...
      RoleDelegateUserIdentity serviceIdentity = (RoleDelegateUserIdentity) _delegateSpnegoLoginService.login(username, credentials, request, getOrCreateSession);
      ...
      if (doAsUser != null && !doAsUser.isEmpty() && httpRequest != null) {
        doAsIdentity = _endUserAuthorizer.getUserIdentity(httpRequest, doAsUser);
      }
